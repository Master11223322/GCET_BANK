package com.bank.gcetbank.Sign;
...
import com.bank.gcetbank.Job.Contractor;
import com.bank.gcetbank.Job.Doctor;
import com.bank.gcetbank.Job.Driver;
import com.bank.gcetbank.Job.Engineer;
import com.bank.gcetbank.Job.Entrepreneur;
import com.bank.gcetbank.Job.Farmer;
import com.bank.gcetbank.Job.Job;
import com.bank.gcetbank.Job.Police;
import com.bank.gcetbank.Job.Soldier;
import com.bank.gcetbank.Job.Sportsman;
import com.bank.gcetbank.Job.Student;
import com.bank.gcetbank.Job.Teacher;
import com.bank.gcetbank.Job.Waiter;
import com.bank.gcetbank.Job.Worker;
import com.bank.gcetbank.R;
import com.bank.gcetbank.UserInfo.Address;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void signUp(View view){
        SignIn.mainUser=new User(userNameText.getText().toString(),
        ...
        parseUser.setUsername(SignIn.mainUser.getId());
        parseUser.setPassword(SignIn.mainUser.getPass());



        ParseObject object=new ParseObject("UserInfo");
        object.put("userRealName", SignIn.mainUser.getName());
        object.put("phone", SignIn.mainUser.getPhoneNumber());
        object.put("address", SignIn.mainUser.addressWrite());
        ...
        SignIn.mainUser.setJob(tempJob);
